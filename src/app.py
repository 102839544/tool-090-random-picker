...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 随机选择工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "random-picker".lower() or "clock" in "random-picker".lower():
            self.setup_timer_ui(main)
        elif "random" in "random-picker".lower() or "dice" in "random-picker".lower() or "coin" in "random-picker".lower():
            self.setup_random_ui(main)
        elif "note" in "random-picker".lower() or "todo" in "random-picker".lower():
    ...
    def generate_random(self):
        if "dice" in "random-picker".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "random-picker".lower():
